        ...
        <img class="img-fluid img-profile rounded-circle mx-auto mb-2" src="../../../static/img/profile.jpg" alt="">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <router-link class="nav-link js-scroll-trigger" to="/skill">Skills</router-link>
                    </li>
                    <li class="nav-item">
                        <router-link class="nav-link js-scroll-trigger" to="/interest">Interests</router-link>
                    </li>
                    <li class="nav-item">
